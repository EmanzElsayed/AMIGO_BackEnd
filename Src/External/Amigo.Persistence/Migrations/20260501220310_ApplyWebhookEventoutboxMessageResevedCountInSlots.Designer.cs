...
namespace Amigo.Persistence.Migrations
{
    ...
    [Migration("20260501220310_ApplyWebhookEventoutboxMessageResevedCountInSlots")]
    partial class ApplyWebhookEventoutboxMessageResevedCountInSlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Amigo.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<string>("CommentForProvider")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("NameAndAddressOfAccomodation")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Amigo.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.Property<string>("HotelNameAddress")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Amigo.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Amigo.Domain.Entities.Order", null)
                        .WithMany("Payments")
