...
namespace Amigo.Application.Services.Admin
{
                 ...
                 : IAdminCustomerService
    {
        ...
        //        var totalCapacity = t.AvailableTimes.Sum(s => s.MaxCapacity);
        ...
        //    return "LOW";
        //}
        public Task<Result<GetCustomersDashboardResponseDTO>> GetadminCustomerDashboardAsync()
        {
            throw new NotImplementedException();
        }

        public Task<Result<PaginatedResponse<AdminCustomerResponseDTO>>> GetCustomersAsync(GetAllCustomersQuery query)
        {
            throw new NotImplementedException();
        }

        public Task<Result<PaginatedResponse<TopPerformingActivityDTO>>> GetDashboardActivitiesAsync(GetAllAdminTourQuery query)
        {
            throw new NotImplementedException();
        }

        public Task<Result<UpdateVipResponseDTO>> UpdateVipStatusAsync(string id, UpdateVipStatusRequestDTO request)
        {
            throw new NotImplementedException();
        }
    }
