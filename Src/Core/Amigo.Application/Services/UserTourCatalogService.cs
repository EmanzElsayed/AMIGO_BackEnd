                ...
                : IUserTourCatalogService
{
    ...
    //    return list;
    //}
    public Task<Result<MaxDurationHoursResponseDto>> GetMaxDurationHoursForDestinationAsync(Guid destinationId)
    {
        throw new NotImplementedException();
    }

    public Task<Result<MaxPriceResponseDto>> GetMaxPriceForDestinationAsync(Guid destinationId)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<Result<IEnumerable<string>>> GetTourCategoriesAsync(Guid destinationId, string? language)
    {
        throw new NotImplementedException();
    }

    public Task<Result<PaginatedResponse<UserTourListItemDto>>> GetToursAsync(GetUserToursQuery query)
    {
        throw new NotImplementedException();
    }

    public Task<Result<IEnumerable<UserTrendingTourItemDto>>> GetTrendingToursAsync(string? language, string? currency, string? userType, int take = 10)
    {
        throw new NotImplementedException();
    }
}
